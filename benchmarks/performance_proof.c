/**
 * PERFORMANCE COMPARISON: KEYSTONE vs reference search
 *
...
int main() {
    printf("PERFORMANCE COMPARISON: KEYSTONE vs reference search\n");
    printf("======================================================\n\n");
    ...
    printf("KEYSTONE:             measure on target hardware\n\n");
    ...
    printf("   KEYSTONE:       measured per run\n");
    ...
    printf("   KEYSTONE observed:       run benchmark_comparison or dsmil_benchmark\n");

    printf("\nConclusion:\n");
    printf("   KEYSTONE delivered the fastest observed latency in this run\n");
